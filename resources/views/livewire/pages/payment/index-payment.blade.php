<div>
        ...
        <div class="d-block rouned shadow">
            ...
            <div class="d-block p-3">
                ...
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <p class="mb-0 fw-bold">{{ date('d F Y', strtotime($payment->deathline)) }}, {{ date('H:i', strtotime($payment->time)) }} WIB</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="d-block rounded shadow bg-white">
            ...
            <div class="p-3">
                ...
                <div class="row mb-2">
                    ...
                    <p class="col-12 col-md-9 col-lg-8 mb-0">{{ date('d F Y', strtotime($purchases->date)) }}, {{ date('H:i', strtotime($purchases->time)) }}WIB</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="d-block rounded shadow">
            ...
            <div class="d-block p-3">
                <div class="row mb-3">
                    ...
                    <p class="col-12 col-md-9 col-lg-8 mb-0"><span class="text-uppercase">{{ $shipping->expedition }}</span> - {{ $shipping->service }}</p>
                </div>
                <div class="row mb-3">
    ...
    <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-1xKvWBWTd6Jk5M0x">
    </script>
