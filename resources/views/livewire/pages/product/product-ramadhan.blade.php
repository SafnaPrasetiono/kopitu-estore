    ...
    <div class="productRmd opacity-0 py-3 py-md-4">
        <div class="container">
            <div class="d-block mb-3">
                <h4 class="mb-0 text-capitalize text-orange">Produk Bulan <span class="text-dark">Ramadhan</span></h4>
                <p class="mb-0 text-secondary">Cari produk ramadhan yuk cek sekarang.</p>
            </div>
                        ...
                        <div class="owl-item h-100">
                            <div class="card border-0 shadow-box h-100 cartRmd opacity-0" style="width: 200px;">
                                <a href="{{ route('product.detail', ['slug' => $itemRmd->slug]) }}"
                                    ...
                                    <img src="{{ url('/images/product/' . $itemRmd->images) }}" class="card-img-top"
                                        alt="...">
                                </a>
                                <div class="card-body">
