                ...
                <div class="row gy-4">
                    <div class="col-12 col-md-6">
                        ...
                        <p class="mb-4">Kopitu e-store merupakan tempat berbelanja online yang menyedikan berbagai macam
                            produk umkm dengan kulitas produk pilihan terbaik.</p>
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <nav class="nav flex-column">
                            <a class="nav-link footer-link" href="#">Produk terbaru</a>
                    ...
                    <div class="col-12 col-md-6 col-lg-2">
                        ...
                        <nav class="nav flex-column">
                            <a class="nav-link footer-link" href="{{ route('index.info.fulfillment') }}">Fulfilment</a>
                            <a class="nav-link footer-link" href="{{ route('index.info.enabler') }}">Enabler</a>
                            <a class="nav-link footer-link" href="#">Kopitu Treuner</a>
                        </nav>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-center justify-content-md-between">
                    <div class="text-white">
                        <nav class="nav justify-content-center mb-3 mb-lg-0">
                            ...
                            <a class="nav-link py-0 px-0 me-3" href="#">
                                <img src="{{ url('/images/icons/instagram.png') }}" alt="facebook"
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div class="ms-2">
                            ...
                            <p class="text-light">+62 813-1173-6178</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white text-orange py-3">
            <div class="container">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <small class="ms-2">
                        Sopported by komite pengusaha mikro kecil menengah indonesia bersatu (KOPITU).
                    </small>
                </div>
            </div>
        </div>
    ...
    <div class="menu-balloon">
        <div class="dropstart">
            ...
            <div class="contact-menu dropdown-menu animate__animated animate__fadeInUp"
                ...
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=+6281311736178" target="_balnk">
                ...
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=6281325199663" target="_balnk">
                    <div class="d-flex align-items-center">
