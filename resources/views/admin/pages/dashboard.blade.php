...
@section('head')
    <title>estore - wellcome in dashboard pages</title>
@endsection
        ...
        <div class="col-12">
            <div class="d-flex bg-white shadow rounded p-3 align-items-center justify-content-between">
                ...
                <div class="lh-sm">
                    ...
                    <small class="text-warning d-block text-end">+ Rp. {{ number_format($pendingIncome, 0, ',','.') }}</small>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card p-2 shadow">
                <div class="d-flex align-items-center px-2">
                    ...
                    <div class="card-body text-end">
                        <p class="card-title fs-2 mb-0">{{ $product->count() }}</p>
                    </div>
                </div>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <div class="card p-2 shadow">
                <div class="d-flex align-items-center px-2">
                    ...
                    <div class="card-body text-end">
                        <p class="card-title fs-2 mb-0">{{ $user->count() }}</p>
                    </div>
                </div>
                <div class="card-footer bg-white px-1">
