    ...
    <div class="container">
        <div class="row">
                ...
                <div class="d-block rounded overflow-hidden">
                    <div class="owl-carousel owlCarousel owl-theme owl-loaded p-0">
                        <div class="owl-stage-outer">
                            <div class="owl-stage">
                                <div class="owl-item">
                                    <img src="{{ url('/images/banner/banner-one.png') }}" alt="" class="w-100">
                                </div>
                                <div class="owl-item">
                                    <img src="{{ url('/images/banner/fulfillment.png') }}" alt="#" class="w-100">
                                </div>
                                <div class="owl-item">
                                    <img src="{{ url('/images/banner/rfq.png') }}" alt="#" class="w-100">
                                </div>
                            </div>
                        </div>
                        <button
            ...
            <div class="col-12 col-md-4 d-none d-md-block">
                <div class="row g-3">
                    <div class="col-12">
                        <img src="{{ url('/images/banner/fulfillment.png') }}" alt="#" class="img-fluid rounded">
                    </div>
                    <div class="col-12">
                        <img src="{{ url('/images/banner/rfq.png') }}" alt="#" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center gy-4">
            <div class="col-12 col-md-6">
                <ul class="nav d-block position-relative rounded border-md" id="myTab" style="height: 280px!important;">
                    <li class="position-absolute start-50 translate-middle" style="top: 35%;">
                        <button class="btn rounded shadow border p-0 btn-esystem active" data-bs-toggle="tab"
                            ...
                            <img src="{{ url('/images/logo/kopitu-estore-system.jpeg') }}" alt="" width="100px">
                        </button>
                    </li>
                    <li class="position-absolute start-50 translate-middle" role="presentation"
                        ...
                        <button class="btn rounded shadow border p-0 btn-esystem" data-bs-toggle="tab"
                            ...
                            <img src="{{ url('/images/logo/kopitu-fulfillment-system.jpeg') }}" alt="" width="100px">
                        </button>
                    </li>
                    <li class="position-absolute start-50 translate-middle" role="presentation"
                        style="margin-left: 120px; top: 55%;">
                        <button class="btn rounded shadow border p-0 btn-esystem" data-bs-toggle="tab"
                            ...
                            <img src="{{ url('/images/logo/kopitu-enambler-system.jpeg') }}" alt="" width="100px">
                        </button>
                    </li>
                </ul>
            </div>
