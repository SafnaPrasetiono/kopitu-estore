...
@section('head')
<title>kopitu - semua produk</title>
<style>
    .card-items {
        width: 14rem;
    }
        ...
        <div class="col-12 col-md-4 col-lg-3 order-last order-md-first">
            <div class="d-block rounded shadow mb-4">
                ...
                <div class="nav flex-column">
                    @foreach ($ctg as $item)
                    <a class="nav-link link-secondary" href="{{ route('product.category', ['ctg' => $item->slug]) }}">{{
                        $item->categories }}</a>
                    @endforeach
            ...
            <div class="d-block rounded shadow mb-4">
                ...
                <div class="nav flex-column">
                    ...
                    <a href="#" class="nav-link link-secondary">Produk banyak dilihat</a>
